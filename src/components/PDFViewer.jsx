...
const PDFViewer = () => {
  ...
  const handleDownload = () => {
    ...
    window.location.href = `https://mod.dpzoning.com/api/download-pdf/${outwardNumber}`;   //http://localhost:5000/download-pdf/${outwardNumber}
  };
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-lg p-4">
            <div className="w-full h-[800px] relative">
              <iframe
                src={`https://mod.dpzoning.com/api/view-pdf`}  //http://localhost:5000/view-pdf
